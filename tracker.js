...
(function(){
	...
	*/
	function addLateBrother(){
		...
		let url = "http://quorumcounter337.herokuapp.com:process.env.PORT/?mode=update";
	...
	function getCheckIn(){
		...
		let url = "http://quorumcounter337.herokuapp.com:process.env.PORT/";
		fetch(url, fetchOptions)
			.then(checkStatus)
			.then(function(responseText){
			})
...
function statistics(){
	//console.log("here");
	let url = "http://quorumcounter337.herokuapp.com:process.env.PORT/?mode=graph";
	fetch(url)
			.then(checkStatus)
		    .then(function(responseText) {
		    	console.log("a");
...
function initialList(){
	let url = "http://quorumcounter337.herokuapp.com:process.env.PORT/?mode=initial";
	fetch(url)
			.then(checkStatus)
		    .then(function(responseText) {
		    	//console.log("here");
