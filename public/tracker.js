...
(function(){
	...
	*/
	function addLateBrother(){
		...
		let url = "https://quorumtracker.herokuapp.com/?mode=update";
	...
	function getCheckIn(){
		...
		let url = "https://quorumtracker.herokuapp.com/";
		fetch(url, fetchOptions)
			.then(checkStatus)
			.then(function(responseText){
			})
...
function statistics(){
	//console.log("here");
	let url = "https://quorumtracker.herokuapp.com/?mode=graph";
	fetch(url)
			.then(checkStatus)
		    .then(function(responseText) {
		    	console.log("a");
...
function initialList(){
	let url = "https://quorumtracker.herokuapp.com/?mode=initial";
	fetch(url)
			.then(checkStatus)
		    .then(function(responseText) {
		    	//console.log("here");
